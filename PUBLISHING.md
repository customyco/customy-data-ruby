...
External one-time setup: Create a pending RubyGems trusted publisher for customyco/customy-data-ruby, workflow publish.yml, environment release and gem name customy-data.
